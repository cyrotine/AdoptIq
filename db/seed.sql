...
-- difficulty_score mapping: Easy=20 / Medium=50 / Hard=80.
...
insert into questions
  (question_text, option_a, option_b, option_c, option_d, correct_answer, explanation, topic_id, difficulty_label, difficulty_score, estimated_time)
values
  (
